...
nsis: {
    ...
    /*
     * Wajib false agar installer tidak langsung
     * menginstal tanpa menampilkan langkah-langkah.
     */
    oneClick: false,

    /*
     * Menampilkan halaman pemilihan direktori instalasi.
     */
    allowToChangeInstallationDirectory: true,

    /*
     * Instalasi hanya untuk pengguna Windows yang aktif.
     * Biasanya tidak membutuhkan hak administrator.
     */
    perMachine: false,
    ...
    /*
     * Membuka aplikasi setelah proses instalasi selesai.
     */
    runAfterFinish: true,
